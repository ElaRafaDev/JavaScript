...
document.body.innerHTML += `O primeiro índice da letra "a" no seu nome: <strong>${nome.indexOf('a')}</strong><br>`;
document.body.innerHTML += `O último índice da letra "e" no seu nome: <strong>${nome.lastIndexOf('e')}</strong><br>`;
